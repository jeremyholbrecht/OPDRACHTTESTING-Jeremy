...
public class ComputerServiceImpl implements ComputerService {
    ...
    //TODO: Check if this method returns a list full of computers that need reparation
    @Override
    public List<Computer> getAllBrokenComputers() {
        return computerRepository.findByNeedsReparationTrue();
    }

    //TODO: Check if this method returns a list full of computers that DON'T need reparation!!!
    @Override
